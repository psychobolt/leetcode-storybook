...
import code from './singleNumber.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Math/Easy/[136] Single Number/Solution/Javascript" />

# Solution

Modify the solution file `./singleNumber.es3.cjs` to test results.
