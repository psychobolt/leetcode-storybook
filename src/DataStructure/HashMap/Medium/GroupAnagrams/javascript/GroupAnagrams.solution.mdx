...
import code from './groupAnagrams.js?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Hash Map/Medium/[49] Group Anagrams/Solution/Javascript" />

# Solution

Modify the solution file `./groupAnagrams.js` to test results.
