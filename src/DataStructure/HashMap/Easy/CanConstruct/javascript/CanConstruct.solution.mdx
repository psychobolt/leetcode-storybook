...
import code from './canConstruct.js?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Hash Map/Easy/[383] Ransom Note/Solution/Javascript" />

# Solution

Modify the solution file `./canConstruct.js` to test results.
