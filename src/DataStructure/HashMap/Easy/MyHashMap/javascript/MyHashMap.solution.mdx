...
import code from './MyHashMap.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Hash Map/Easy/[706] Design HashMap/Solution/Javascript" />

# Solution

Modify the solution file `./MyHashMap.es3.cjs` to test results.
