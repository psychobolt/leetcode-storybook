...
import code from './hasCycle.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Linked List/Easy/[141] Linked List Cycle/Solution/Javascript" />

# Solution

Modify the solution file `./hasCycle.es3.cjs` to test results.
