...
import code from './lengthOfLongestSubstring.js?raw';
import runTestCase, { cases } from '../testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/String/Medium/[3] Longest Substring Without Repeating Characters/Solution/Javascript/Hash Set" />

# Solution

Modify the solution file `./lengthOfLongestSubstring.js` to test results.
