...
import code from './kthGrammar.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/String/Medium/[779] K-th Symbol in Grammar/Solution/Javascript" />

# Solution

Modify the solution file `./kthGrammar.es3.cjs` to test results.
