...
import code from './reverseString.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/String/Easy/[344] Reverse String/Solution/Javascript/Two Pointers" />

# Solution

Modify the solution file `./reverseString.es3.cjs` to test results.
