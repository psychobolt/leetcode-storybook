...
import code from './getRow.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Array/1D/Easy/[119] Pascal's Triangle II/Solution/Javascript/Two Pointers" />

# Solution

Modify the solution file `./getRow.es3.cjs` to test results.
