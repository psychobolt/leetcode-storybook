...
import code from './fizzBuzz.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];

<Meta title="Data Structure/Array/1D/Easy/[412] Fizz Buzz/Solution/Javascript" />

# Solution

Modify the solution file `./fizzBuzz.es3.cjs` to test results.
