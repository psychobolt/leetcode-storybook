...
import code from './heightChecker.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[5];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Array/1D/Easy/[1051] Height Checker/Solution/Javascript" />

# Solution

Modify the solution file `./heightChecker.es3.cjs` to test results.
