...
import code from './countKDifference.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Array/1D/Easy/[2006] Count Number of Pairs With Absolute Difference K/Solution/Javascript" />

# Solution

Modify the solution file `./countKDifference.es3.cjs` to test results.
