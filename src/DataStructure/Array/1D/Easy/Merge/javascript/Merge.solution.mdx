...
import code from './merge.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];

<Meta title="Data Structure/Array/1D/Easy/[88] Merge Sorted Array/Solution/Javascript" />

# Solution

Modify the solution file `./merge.es3.cjs` to test results.
