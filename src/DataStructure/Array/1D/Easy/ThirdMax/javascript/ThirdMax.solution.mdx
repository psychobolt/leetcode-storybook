...
import code from './thirdMax.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Array/1D/Easy/[414] Third Maximum Number/Solution/Javascript" />

# Solution

Modify the solution file `./thirdMax.es3.cjs` to test results.
