...
import code from './smallestDistancePair.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[4];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Array/1D/Hard/[719] Find K-th Smallest Pair Distance/Solution/Javascript" />

# Solution

Modify the solution file `./smallestDistancePair.es3.cjs` to test results.
