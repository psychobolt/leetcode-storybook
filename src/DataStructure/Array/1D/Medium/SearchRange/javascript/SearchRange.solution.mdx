...
import code from './searchRange.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Array/1D/Medium/[34] Find First and Last Position of Element in Sorted Array/Solution/Javascript" />

# Solution

Modify the solution file `./searchRange.es3.cjs` to test results.
