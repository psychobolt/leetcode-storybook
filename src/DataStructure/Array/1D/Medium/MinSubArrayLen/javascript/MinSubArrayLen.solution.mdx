...
import code from './minSubArrayLen.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[6];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Array/1D/Medium/[209] Minimum Size Subarray Sum/Solution/Javascript" />

# Solution

Modify the solution file `./minSubArrayLen.es3.cjs` to test results.
