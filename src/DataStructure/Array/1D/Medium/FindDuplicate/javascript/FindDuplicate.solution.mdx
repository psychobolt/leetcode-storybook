...
import code from './findDuplicate.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Array/1D/Medium/[287] Find the Duplicate Number/Solution/Javascript" />

# Solution

Modify the solution file `./findDuplicate.es3.cjs` to test results.
