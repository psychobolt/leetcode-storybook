...
import code from './rotate.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Array/1D/Medium/[189] Rotate Array/Solution/Javascript" />

# Solution

Modify the solution file `./rotate.es3.cjs` to test results.
