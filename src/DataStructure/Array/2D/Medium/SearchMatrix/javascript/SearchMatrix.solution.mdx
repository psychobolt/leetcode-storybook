...
import code from './searchMatrix.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[4];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Array/2D/Medium/[74] Search a 2D Matrix/Solution/Javascript" />

# Solution

Modify the solution file `./searchMatrix.es3.cjs` to test results.
