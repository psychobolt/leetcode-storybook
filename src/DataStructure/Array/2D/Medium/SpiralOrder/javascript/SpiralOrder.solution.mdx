...
import code from './spiralOrder.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[3];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Array/2D/Medium/[54] Spiral Matrix/Solution/Javascript" />

# Solution

Modify the solution file `./spiralOrder.es3.cjs` to test results.
