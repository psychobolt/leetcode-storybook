...
import code from './generate.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Array/2D/Easy/[118] Pascal's Triangle/Solution/Javascript" />

# Solution

Modify the solution file `./generate.es3.cjs` to test results.
