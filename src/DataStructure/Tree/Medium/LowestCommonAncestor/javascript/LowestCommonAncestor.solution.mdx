...
import code from './lowestCommonAncestor.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Tree/Medium/[236] Lowest Common Ancestor of a Binary Tree/Solution/Javascript" />

# Solution

Modify the solution file `./lowestCommonAncestor.es3.cjs` to test results.
