...
import code from './findDuplicateSubtrees.js?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Tree/Medium/[652] Find Duplicate Subtrees/Solution/Javascript" />

# Solution

Modify the solution file `./findDuplicateSubtrees.es3.cjs` to test results.
