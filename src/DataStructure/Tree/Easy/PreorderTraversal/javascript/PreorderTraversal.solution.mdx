...
import code from './preorderTraversal.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Tree/Easy/[144] Binary Tree Preorder Traversal/Solution/Javascript" />

# Solution

Modify the solution file `./preorderTraversal.es3.cjs` to test results.
