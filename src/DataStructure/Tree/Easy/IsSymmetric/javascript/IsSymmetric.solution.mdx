...
import code from './isSymmetric.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Tree/Easy/[101] Symmetric Tree/Solution/Javascript" />

# Solution

Modify the solution file `./isSymmetric.es3.cjs` to test results.
