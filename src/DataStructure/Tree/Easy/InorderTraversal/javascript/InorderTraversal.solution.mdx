...
import code from './inorderTraversal.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Tree/Easy/[94] Binary Tree Inorder Traversal/Solution/Javascript" />

# Solution

Modify the solution file `./inorderTraversal.es3.cjs` to test results.
