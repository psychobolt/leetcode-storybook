...
import code from './maxDepth.es3.cjs?raw';
import runTestCase, { cases } from '../testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Tree/Easy/[104] Maximum Depth of Binary Tree/Solution/Javascript/Bottom Up" />

# Solution

Modify the solution file `./maxDepth.es3.cjs` to test results.
