...
import code from './serialize.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Tree/Hard/[297] Serialize and Deserialize Binary Tree/Solution/Javascript" />

# Solution

Modify the solution file `./serialize.es3.cjs` to test results.
