...
import code from './updateMatrix.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Queue/Medium/[542] 01 Matrix/Solution/Javascript" />

# Solution

Modify the solution file `./updateMatrix.es3.cjs` to test results.
