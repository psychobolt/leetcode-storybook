...
import code from './isValid.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Stack/Easy/[20] Valid Parentheses/Solution/Javascript" />

# Solution

Modify the solution file `./isValid.es3.cjs` to test results.
