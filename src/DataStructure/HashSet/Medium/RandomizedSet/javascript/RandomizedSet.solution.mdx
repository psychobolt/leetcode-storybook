...
import code from './RandomizedSet.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Hash Set/Medium/[380] Insert Delete GetRandom O(1)/Solution/Javascript" />

# Solution

Modify the solution file `./RandomizedSet.es3.cjs` to test results.
