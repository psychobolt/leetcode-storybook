...
import code from './numJewelsInStones.js?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Hash Set/Easy/[771] Jewels and Stones/Solution/Javascript" />

# Solution

Modify the solution file `./numJewelsInStones.js` to test results.
