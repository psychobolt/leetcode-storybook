...
import code from './checkIfExist.js?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Data Structure/Hash Set/Easy/[1346] Check If N and Its Double Exist/Solution/Javascript" />

# Solution

Modify the solution file `./checkIfExist.js` to test results.
