...
import code from './findPeakElement.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Algorithms/Binary Search/Medium/[162] Find Peak Element/Solution/Javascript" />

# Solution

Modify the solution file `./findPeakElement.es3.cjs` to test results.
