...
import code from './search.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Algorithms/Binary Search/Medium/[33] Search in Rotated Sorted Array/Solution/Javascript" />

# Solution

Modify the solution file `./search.es3.cjs` to test results.
