...
import code from './solution.es3.cjs?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[0];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Algorithms/Binary Search/Easy/[278] First Bad Version/Solution/Javascript" />

# Solution

Modify the solution file `./solution.es3.cjs` to test results.
