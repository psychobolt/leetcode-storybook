...
import code from './guessNumber.js?raw';
import runTestCase, { cases } from './testCases.js';

export const c0 = cases[1];
export const printOutput = memoize(() => JSON.stringify(runTestCase(solution, cloneDeep(c0))));

<Meta title="Algorithms/Binary Search/Easy/[374] Guess Number Higher or Lower/Solution/Javascript" />

# Solution

Modify the solution file `./guessNumber.es3.cjs` to test results.
